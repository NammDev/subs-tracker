const title = 'Subs Tracker | Privacy Policy'
  ...
  return (
    <main className='w-full flex flex-col px-2 my-6'>
      ...
      <p className='my-1 leading-7'>
        ...
        built the Subs Tracker app as a Freemium app. This SERVICE is provided at no cost and is
      ...
      <p className='my-1 leading-7'>
        ...
        which are accessible at Subs Tracker unless otherwise defined in this Privacy Policy.
      </p>
      <h3 className='font-semibold text-lg my-2'>Information Collection and Use</h3>
      <p className='my-1 leading-7'>
        For a better experience, while using our Service, I may require you to provide us with
        certain personally identifiable information, including but not limited to Email Id, Profile
        Photo and Full name via Google OAuth Login by you. The app does use third-party services
      ...
      <div>
        <p className='my-1 leading-7'>
          I do not knowingly collect personally identifiable information from children. I encourage
          all children to never submit any personally identifiable information through the
          Application and/or Services. I encourage parents and legal guardians to monitor their
          ...
          and/or Services without their permission. If you have reason to believe that a child has
          provided personally identifiable information to us through the Application and/or
          Services, please contact us. You must also be at least 16 years of age to consent to the
          processing of your personally identifiable information in your country (in some countries
          we may allow your parent or guardian to do so on your behalf).
        </p>
      </div>
      <h3 className='font-semibold text-lg my-2'>Changes to This Privacy Policy</h3>
      <p className='my-1 leading-7'>
      ...
      <p className='my-1 leading-7'>
        This policy is effective as of <span className='font-medium'>2024-03-01</span>.
      </p>
